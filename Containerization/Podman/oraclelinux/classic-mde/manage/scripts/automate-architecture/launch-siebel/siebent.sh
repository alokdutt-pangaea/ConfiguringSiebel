ROOT=/mnt/c/siebel/ConfiguringSiebel/Containerization/Podman/oraclelinux/classic-mde/manage/scripts/automate-architecture
PV=/mnt/c/persistent
...
ENTPROFILE=DEV
HWSERVER=localhost
COMPGRPS=adm,callcenter,workflow,siebelwebtools,eai
LANGS=enu
SES1SERVERNAME=SES
SFS=/sfs
